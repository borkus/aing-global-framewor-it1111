...
const PROJECT_NAME = "aing-global-framewor-it23ozfod7kshvs8ydxvf";
...
function updatePackageJson() {
    try {
        ...
        // Fix deploy script - wrangler deploy only (build already ran separately)
        if (pkg.scripts) {
